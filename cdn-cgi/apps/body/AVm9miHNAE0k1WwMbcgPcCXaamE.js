;
if (CloudflareApps.matchPage(CloudflareApps.installs['R7Vx4h7FqNeK'].URLPatterns)) {
    (function(modules) {
    ...
    ({
        "./src/index.js": (function(module, exports, __webpack_require__) {
            ...
            function check_plan() {
                var options = CloudflareApps.installs['R7Vx4h7FqNeK'].options;
                var product = CloudflareApps.installs['R7Vx4h7FqNeK'].product;
            ...
            function init() {
                ...
                var sub_domain_tracker_ids = CloudflareApps.installs['R7Vx4h7FqNeK'].options.subdomain_tracker_ids;
                var options = CloudflareApps.installs['R7Vx4h7FqNeK'].options;
                var product = CloudflareApps.installs['R7Vx4h7FqNeK'].product;
                if (product && product.id === 'google-analytics-pro' && true) {
                    ...
                    if (subdomain_tracker[0] && subdomain_tracker[0].tracker_id) {
                        ...
                        send_to_google_analytics(CloudflareApps.installs['R7Vx4h7FqNeK'].options.tracker_id);
                    }
                } else {
                    send_to_google_analytics(CloudflareApps.installs['R7Vx4h7FqNeK'].options.tracker_id);
                }
