...
$jscomp.polyfill = function(f, m, v, t) {
    if (m) {
        ...
        t = v[f];
        m = m(t);
        m != t && null != m && $jscomp.defineProperty(v, f, {
            configurable: !0,
            writable: !0,
            value: m
        })
...
var DracoDecoderModule = function() {
    ...
    return function(m) {
        ...
        function ma(k) {
            function c() {
                if (!fa && (fa = !0, !za)) {
                    ...
                    if (a.postRun)
                        for ("function" == typeof a.postRun && (a.postRun = [a.postRun]); a.postRun.length;) Ea.unshift(a.postRun.shift());
                    S(Ea)
                }
            }
            if (!(0 < aa)) {
        ...
        else if (ea || Z) Z ? M = self.location.href : document.currentScript && (M = document.currentScript.src), f && (M = f), M = 0 !== M.indexOf("blob:") ? M.substr(0, M.lastIndexOf("/") + 1) : "", ra = function(a) {
        ...
        var ia, gb = new WebAssembly.Table({
                initial: 293,
                maximum: 293,
                element: "anyfunc"
            }),
