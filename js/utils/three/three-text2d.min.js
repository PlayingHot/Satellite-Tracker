! function(t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e(require("THREE")) : "function" == typeof define && define.amd ? define(["THREE"], e) : "object" == typeof exports ? exports.THREE_Text2D = e(require("THREE")) : t.THREE_Text2D = e(t.THREE)
}(window, function(t) {
    return function(t) {
        var e = {};
        ...
        e.getFontHeight = function(t) {
            ...
            if (!e) {
                ...
                n.appendChild(s), n.setAttribute("style", "font:" + t + ";position:absolute;top:0;left:0"), i.appendChild(n), e = n.offsetHeight, r[t] = e, i.removeChild(n)
            }
            return e
        }
    }, function(t, e, i) {
        ...
        var s = i(0),
            ...
            h = function(t) {
                function e(e, i) {
                    ...
                    return n._align = new s.Vector2, n._font = i.font || "30px Arial", n._fillStyle = i.fillStyle || "#FFFFFF", n._shadowColor = i.shadowColor || "rgba(0, 0, 0, 0)", n._shadowBlur = i.shadowBlur || 0, n._shadowOffsetX = i.shadowOffsetX || 0, n._shadowOffsetY = i.shadowOffsetY || 0, n._lineHeight = i.lineHeight || 1.2, n.canvas = new a.CanvasText, n.align = i.align || o.textAlign.center, n.side = i.side || s.DoubleSide, n.antialias = void 0 === i.antialias || i.antialias, n.text = e, n
                }
                return r(e, t), Object.defineProperty(e.prototype, "width", {
                    ...
                    !1 === this.antialias && (this.texture.magFilter = s.NearestFilter, this.texture.minFilter = s.LinearMipMapLinearFilter)
                }, e
            }(s.Object3D);
        e.Text2D = h
    }, function(t, e, i) {
        ...
        var s = i(0),
            o = function(t) {
                ...
                return r(e, t), e.prototype.raycast = function() {
                    ...
                    this.canvas.drawText(this._text, {
                        ...
                        align: this.align
                    }), this.cleanUp(), this.texture = new s.Texture(this.canvas.canvas), this.texture.needsUpdate = !0, this.applyAntiAlias(), this.material ? this.material.map = this.texture : this.material = new s.SpriteMaterial({
                        map: this.texture
                    }), this.sprite || (this.sprite = new s.Sprite(this.material), this.add(this.sprite)), this.sprite.scale.set(this.canvas.width, this.canvas.height, 1), this.updateAlign()
                }, e.prototype.updateAlign = function() {
                    this.sprite && (this.sprite.center.x = (.5 - .5 * this._align.x) * this.canvas.textWidth / this.canvas.width, this.sprite.center.y = 1 - (.5 * this._align.y + .5) * this.canvas.textHeight / this.canvas.height)
                }, Object.defineProperty(e.prototype, "align", {
                    get: function() {
                        return this._align
                    },
                    set: function(t) {
                        this._align.copy(t), this.updateAlign()
                    },
                    enumerable: !0,
                    configurable: !0
                }), e
        ...
        var n = i(0),
            ...
            s = function() {
                ...
                return Object.defineProperty(t.prototype, "width", {
                    ...
                    var s = r.getFontHeight(e.font),
                        o = (t || "").toString().split("\n");
                    this.textWidth = Math.max.apply(null, o.map(function(t) {
                        return Math.ceil(i.ctx.measureText(t).width)
                    })), this.textHeight = s + s * e.lineHeight * (o.length - 1), this.canvas.width = Math.max(2, n.Math.ceilPowerOfTwo(this.textWidth)), this.canvas.height = Math.max(2, n.Math.ceilPowerOfTwo(this.textHeight)), this.ctx.font = e.font, this.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height), this.ctx.fillStyle = e.fillStyle, 1 === e.align.x ? this.ctx.textAlign = "left" : 0 === e.align.x ? this.ctx.textAlign = "center" : this.ctx.textAlign = "right", this.ctx.textBaseline = "top", this.ctx.shadowColor = e.shadowColor, this.ctx.shadowBlur = e.shadowBlur, this.ctx.shadowOffsetX = e.shadowOffsetX, this.ctx.shadowOffsetY = e.shadowOffsetY;
                    for (var a = this.textWidth * (.5 - .5 * e.align.x), h = 0; h < o.length; h++) this.ctx.fillText(o[h], a, s * e.lineHeight * h);
                    return this.canvas
                }, t
            }();
        e.CanvasText = s
        ...
        var s = i(0),
            o = function(t) {
                function e(e, i) {
                    return void 0 === e && (e = ""), void 0 === i && (i = {}), t.call(this, e, i) || this
                }
                return r(e, t), e.prototype.raycast = function() {
                    ...
                    this.cleanUp(), this.canvas.drawText(this._text, {
                        ...
                        lineHeight: this._lineHeight,
                        align: this.align
                    }), this.texture = new s.Texture(this.canvas.canvas), this.texture.needsUpdate = !0, this.applyAntiAlias(), this.material ? this.material.map = this.texture : (this.material = new s.MeshBasicMaterial({
                        map: this.texture,
                        side: this.side
